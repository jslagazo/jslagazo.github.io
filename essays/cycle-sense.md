...
<p style="text-align:center;">
  <img width="900px" src="../img/uhm_logo.png" alt="UH Manoa Logo">
</p>
...
## Approach: Our Mockup Page Ideas
...
1. **Home Page**:
    Introduces CycleSense, explains its purpose, and provides quick access to major features of the application.
2. **Map Page**:
...
5. **Statistics Page**: 
    Present sustainability-related information in a simple yet engaging way.
6. **Admin Management Page**:
    *May* also be included so authorized users can add, remove, or update map pins and announcements; to help keep the system maintainable and relevant over time.

## Use Case Ideas
Here is our end-to-end scenarios of using the system:
1. Users goes to the home page, can navigate to announcements/map/sorting guide/statistics
2. Admin logs in, goes to the home page, can navigate to announcements/map/sorting guide/statistics, and can add or remove pins in real time
...
## Takeaway
Overall, CycleSense is a project that is technically manageable, directly relevant to the UH Manoa community, and capable of growing into a richer interactive application. The app addresses a real campus problem with a practical solution while leaving room for meaningful features that go beyond a standard website. For these reasons, we believe this is why our proposla is a strong candidate for our ICS 314 final project.